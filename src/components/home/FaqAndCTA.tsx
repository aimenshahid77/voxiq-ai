        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-4">
              ...
              <p className="text-[15px] text-[#1a1a1a] font-medium leading-relaxed mb-8 transition-colors duration-300 dark:text-white/55">
                Everything you need to know about preparing for your next role
                using our platform.
              </p>
              <button
                onClick={() =>
              ...
              {faqData.map((item, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <span
                        className={`text-sm sm:text-[15px] font-bold transition-colors duration-200 ${isOpen ? "text-[#2A6666] dark:text-[#FEF0AF]" : "text-[#1a1a1a] dark:text-white"}`}
                      >
                        {item.question}
                      </span>
                      <span
                        className={`w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 transition-all duration-300 ${
                          isOpen
                            ? "bg-[#2A6666] text-[#FEF0AF] rotate-180 dark:bg-[#FEF0AF] dark:text-[#2A6666]"
                            : "bg-[#E9ECEF] text-[#5C4A3A] dark:bg-white/10 dark:text-white/60"
                        }`}
                      >
                        <svg
                    ...
                    >
                      <p className="px-5 sm:px-6 pb-5 sm:pb-6 text-sm text-[#1a1a1a] leading-relaxed font-medium border-t border-[#E9ECEF] pt-4 dark:border-white/10 dark:text-white/55">
                        {item.answer}
                      </p>
                    </div>
                  </div>
          ...
          <div className="relative bg-[#2A6666] rounded-3xl px-10 sm:px-16 py-16 sm:py-20 overflow-hidden text-center">
            ...
            <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center gap-6">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white leading-[1.1] tracking-tight">
                ...
                <em className="not-italic italic text-[#FEF0AF]">
                  Start owning them.
                </em>
              </h2>

              <p className="text-[#FEF0AF]/60 text-sm font-medium max-w-md leading-relaxed">
                Join hundreds of candidates who practiced smarter, spoke with
                confidence, and landed their dream roles.
              </p>
      ...
      <footer className="bg-white border-t border-[#E9ECEF] px-6 sm:px-12 pt-16 pb-8 transition-colors duration-300 dark:bg-[#0f1717] dark:border-white/10">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between gap-12 mb-14">
            ...
            <div className="max-w-xs flex flex-col gap-4">
              <div className="flex items-center gap-2.5">
                <div className="h-9 w-9 bg-[#2A6666] rounded-xl flex items-center justify-center shadow-md">
                  <span className="text-[11px] font-black text-[#FEF0AF]">
                    AI
                  </span>
                </div>
              ...
              <p className="text-sm text-[#1a1a1a] leading-relaxed font-medium dark:text-white/50">
                Realistic conversational AI practice engineered to conquer
                speaking anxiety and build interview muscle memory.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-10">
              ...
              <div className="flex flex-col gap-3">
                <h5 className="text-[11px] font-black uppercase tracking-widest text-[#1a1a1a] dark:text-white">
                  Product
                </h5>
                <ul className="flex flex-col gap-2">
                  {[
                    ...
                    <li key={label}>
                      <button
                        onClick={action}
                        className="text-sm text-[#1a1a1a] hover:text-[#2A6666] font-medium transition-colors duration-200 dark:text-white/50 dark:hover:text-[#FEF0AF]"
                      >
                        {label}
                      </button>
                    </li>
          ...
          <div className="border-t border-[#E9ECEF] pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 dark:border-white/10">
            <p className="text-[12px] text-[#1a1a1a] font-medium dark:text-white/35">
